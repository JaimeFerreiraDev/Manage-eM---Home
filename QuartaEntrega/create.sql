...
CREATE table Kid(id_Kid int not null, pts_Kid int, Connected Boolean,
...
Create table Kids_Reward (kid int not null, reward int not null, requested tinyint null,
